<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProxyProfitByTax.aspx.cs" Inherits="DimoNetwork.QPProxyWeb.SysRoot.ProxyProfitByTax" %>
                    ...
                    <asp:Repeater ID="reptDataPager" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><a href="javascript:void(0)"  class="tablelink" onclick="getMemberWinLostClick(0,<%#Eval("ProxyId")%>)"><%#Eval("MemberTempTax")%></a> </td>
                                <td><%#Eval("NextProxyTempTax")%></td>
                                <td><%#Eval("assignProportion")%></td>
                                <td><%#Eval("TaxProfit")%></td>
                                <td><%#Eval("TaxPureProfit")%></td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                </tbody>
