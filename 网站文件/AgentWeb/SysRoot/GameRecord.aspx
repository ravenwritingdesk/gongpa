<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GameRecord.aspx.cs" Inherits="DimoNetwork.QPProxyWeb.SysRoot.GameRecord" %>
    ...
    <form id="form1" runat="server">
        <div class="place">
            ...
            <ul class="placeul">
                ...
                <li><a href="/SysRoot/GameRecord.aspx">会员游戏记录</a></li>
            </ul>
        </div>
        ...
        <div class="rightinfo">
            <div class="tabson">
                ...
                <table class="tablelist">
                    ...
                    <tbody>
                        ...
                        <tr style="background-color: #e5ebee" id="statTr" runat="server">
                            ...
                            <%--<td><span class="inSpan" runat="server" id="totalTaxSpan"></span></td>--%>
                ...
                <%-- <div runat="server" id="statDiv" class="statdiv">
                    <span style="margin-left: 30%;">总金币变化值(金币):&nbsp<span class="inSpan" runat="server" id="totalChangeMoneySpan"></span></span>
                    <span style="margin-left: 8%;">总抽水值(金币):&nbsp<span class="inSpan" runat="server" id="totalTaxSpan"></span></span>
                    <span style="margin-left: 8%;">总税收(金币):&nbsp<span class="inSpan" runat="server" id="totalRevenueSpan"></span></span>
                </div>--%>
            </div>
