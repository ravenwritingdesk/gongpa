<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProxyOperateMemberScoreList.aspx.cs" Inherits="DimoNetwork.QPProxyWeb.SysRoot.ProxyOperateMemberScoreList" %>
    ...
    <form id="form1" runat="server">
        <div class="place">
            ...
            <ul class="placeul">
                ...
                <li><a href="/SysRoot/PayOrderManage.aspx">上分下分</a></li>
                <li><a href="/SysRoot/UpDownScore.aspx">会员上分下分</a></li>
            </ul>
        </div>
        ...
        <div class="rightinfo">
            ...
            <div class="tools">
                <ul class="toolbar1" style="width: 70%">
                    <li>代理 <%=this.Proxy.account%> 对会员的上下分详情</li>
                </ul>
                <ul class="toolbar1" style="width: 30%; float: right">
                    <li><a href="UpDownScore.aspx">返回上一页</a></li>
                </ul>
            </div>
