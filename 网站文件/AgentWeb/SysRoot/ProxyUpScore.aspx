<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProxyUpScore.aspx.cs" Inherits="DimoNetwork.QPProxyWeb.SysRoot.ProxyUpScore" %>
    ...
    <form id="form1" runat="server">
        <div class="place">
            ...
            <ul class="placeul">
                ...
                <li><a href="/SysRoot/ProxyUpScore.aspx">代理上分下分</a></li>
            </ul>
        </div>
        ...
        <div class="formbody">
            ...
            <div id="usual1" class="usual">
                ...
                <div id="tab3" class="tabson">
                    ...
                    <div class="formtext">总上分：<b><a href="/SysRoot/ProxyOperateProxyScoreList.aspx?proxyId=<%= Proxy.ProxyID %>&op=0&" class="tablelink"><asp:Literal ID="ltUpScore1" runat="server"></asp:Literal></a></b> 总下分：<b><a href="/SysRoot/ProxyOperateProxyScoreList.aspx?proxyId=<%= Proxy.ProxyID %>&op=1" class="tablelink"><asp:Literal ID="ltDownScore1" runat="server"></asp:Literal></a></b></div>
                    ...
                    <ul class="forminfo">
                        <li>
                            ...
                            <input id="txtProxyId" type="text" class="dfinput" value="" style="width: 150px; height: 32px;" runat="server" />&nbsp;
                    ...
                    <ul class="forminfo" id="liProxyValidate" runat="server" visible="False">
                        ...
                        <li>
                            <label>金额(RMB)：<b>*</b></label><input name="" type="text" class="dfinput" value="" style="width: 150px;" onblur="converttocn(this.value)" onfocus="OperateNumberFocus()" id="txtProxyOperateNumber" runat="server" />
