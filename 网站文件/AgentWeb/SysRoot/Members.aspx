<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Members.aspx.cs" Inherits="DimoNetwork.QPProxyWeb.SysRoot.Members" %>
    ...
    <form id="form1" runat="server">
                    ...
                    <asp:Repeater ID="reptDataPager" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%# Eval("userid")%></td>
                                <td><%#Eval("UserName")%></td>
                                <td><a href="/SysRoot/MemberScoreList.aspx?uid=<%# Eval("UserId")%>&op=0&uname=<%# Eval("UserName")%>" class="tablelink"><%#FormatMoney( Eval("UpScore"))%></a></td>
                                <td><a href="/SysRoot/MemberScoreList.aspx?uid=<%# Eval("UserId")%>&op=1&uname=<%# Eval("UserName")%>" class="tablelink"><%#FormatMoney(Eval("DownScore"))%></a></td>
                                <td><%#FormatMoney(Eval("DiffScore"))%></td>
                                <td><a href="/SysRoot/GameRecord.aspx?uid=<%# Eval("UserId")%>" class="tablelink"><%#FormatMoney(Eval("TotalWin"))%></a></td>
                                <%--<td><%#Eval("Tax") %></td>--%>
                                ...
                                <td>
                                    <%# (Proxy.ProxyLevel == 1) ?
                                "<a href=\"/SysRoot/MemberEdit.aspx?uid=" + Eval("UserId") + "\" class=\"tablelink\">修改</a>&nbsp;" : ""
                                    %>
                     ...
                     <tr style="background-color:#e5ebee" id="statTr" runat="server">
                                ...
                                <%--<td><span class="inSpan" runat="server" id="allTaxSpan"></span></td>--%>
        ...
        <div class="pagination pull-right">
           ...
           FirstPageText="|<" LastPageText=">|" NextPageText=">"
            ...
            PagingButtonLayoutType="UnorderedList" PagingButtonSpacing="0" CurrentPageButtonClass="active" OnPageChanged="anpDataPager_PageChanged"></webdiyer:AspNetPager>
        </div>
