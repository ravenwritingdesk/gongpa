<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberAdd.aspx.cs" Inherits="DimoNetwork.QPProxyWeb.SysRoot.MemberAdd" %>
    ...
    <form id="form1" runat="server">
        <div class="place">
            ...
            <ul class="placeul">
                ...
                <li><a href="/SysRoot/MemberAdd.aspx">添加会员</a></li>
            </ul>
        </div>
        <div class="formbody">
