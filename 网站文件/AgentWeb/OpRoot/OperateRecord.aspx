<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OperateRecord.aspx.cs" Inherits="DimoNetwork.QPProxyWeb.OpRoot.OperateRecord" %>
...
<body>
    <form id="form1" runat="server">
        <div class="place">
            <span>位置：</span>
            <ul class="placeul">
                <li><a href="/OpRoot/OperateRecord.aspx">操作日志</a></li>
            </ul>
        </div>
