<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpDownScore.aspx.cs" Inherits="DimoNetwork.QPProxyWeb.OpRoot.UpDownScore" %>
...
<body>
    <form id="form1" runat="server">
        <div class="place">
            ...
            <ul class="placeul">
                <li><a href="#">上分下分</a></li>
                <li><a href="/OpRoot/UpDownScore.aspx">上分下分</a></li>
            </ul>
        </div>
            ...
            <div id="usual1" class="usual">
                ...
                <div class="itab">
                    <ul>
                        ...
                        <li><a href="#tab3" onclick="location.href='/OpRoot/ProxyUpScore.aspx#tab3'">代理上分下分</a></li>
                    </ul>
                </div>
        ...
        总上分：<b><a href="/OpRoot/ProxyOperateMemberScoreList.aspx?proxyId=<%= Proxy.ProxyID %>&op=0" class="tablelink"><asp:Literal ID="ltUpScore" runat="server"></asp:Literal></a></b> 总下分：<b><a href="/OpRoot/ProxyOperateMemberScoreList.aspx?proxyId=<%= Proxy.ProxyID %>&op=1" class="tablelink"><asp:Literal ID="ltDownScore" runat="server"></asp:Literal></a></b>
                    </div>
                    ...
                    <ul class="forminfo" id="liMemberValidate" runat="server" visible="False">
                        ...
                        <li>
                            <label>&nbsp;</label><asp:Button ID="btnUserUpScore" runat="server" Text="上分（+）" OnClientClick="return Validate(0)" class="btn" OnClick="btnUserUpScore_Click" Visible="False" />
                            &nbsp;<asp:Button ID="btnUserDownScore" runat="server" Text="下分（-）" OnClientClick="return Validate(1)" class="btn" OnClick="btnUserDownScore_Click" Visible="False" /></li>
                    </ul>
                </div>
            </div>
