<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberScoreList.aspx.cs" Inherits="DimoNetwork.QPProxyWeb.OpRoot.MemberScoreList" %>
    ...
    <form id="form1" runat="server">
        <div class="place">
            ...
            <ul class="placeul">
                ...
                <li><a href="/OpRoot/MemberTaxList.aspx">会员抽水值</a></li>
            </ul>
        </div>
                    ...
                    <asp:Repeater ID="reptDataPager" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%#FormatMoney(Convert.ToInt64(Eval("SrcScore").ToString()) - Convert.ToInt64(Eval("ChangeScore").ToString()))%></td>
