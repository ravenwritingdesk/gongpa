<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProxyOperateMemberScoreList.aspx.cs" Inherits="DimoNetwork.QPProxyWeb.OpRoot.ProxyOperateMemberScoreList" %>
    ...
    <form id="form1" runat="server">
        <div class="place">
            ...
            <ul class="placeul">
                ...
                <li><a href="/OpRoot/UpDownScore.aspx">会员上分下分记录</a></li>
            </ul>
        </div>
