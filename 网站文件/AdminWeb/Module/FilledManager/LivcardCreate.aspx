...
<body>
    <form id="form1" runat="server">
        ...
        <tr>
            <td height="28">
                <ul>
                    <li class="tab2" onclick="Redirect('LivcardBuildStreamList.aspx')">实卡管理</li>
                    <li class="tab1">实卡生成</li>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
            ...
            <tr>
                <td class="listTdLeft">实卡类型：
                </td>
                <td>
                    <asp:DropDownList ID="ddlCardType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlCardType_SelectedIndexChanged">
                    </asp:DropDownList>
                    &nbsp;&nbsp;同一分钟内不能生成同一类型的卡多次，以免会造成卡号重复现象！
                </td>
            </tr>
            <tr>
                <td class="listTdLeft">生成数量：
                </td>
                <td>
                    <asp:TextBox ID="txtCount" runat="server" CssClass="text" MaxLength="7" onkeyup="if(isNaN(value))execCommand('undo');"></asp:TextBox>
                    每次最多10000张
                </td>
            </tr>
            <tr>
                <td class="listTdLeft">价格：
                </td>
                <td>
           ...
           <tr>
            ...
            <tr>
                <td class="listTdLeft">开始字符：
                </td>
                <td>
                    <asp:TextBox ID="txtInitial" runat="server" Text="P" CssClass="text" MaxLength="1"></asp:TextBox>
                    开始字符可为空，最大只可为一位
                </td>
            </tr>
           <%--  <tr>
                <td class="listTdLeft">卡号长度：
                </td>
                <td>
                    <asp:TextBox ID="txtCardNumLen" runat="server" CssClass="text" Text="15" MaxLength="2" onkeyup="if(isNaN(value))execCommand('undo');"></asp:TextBox>
                    卡号长度必须大于等于15小于32
                </td>
            </tr>--%>
            <tr>
            ...
            <tr>
                <td class="listTdLeft">密码长度：
                </td>
                <td>
                    <asp:TextBox ID="txtPassLen" runat="server" Text="8" CssClass="text" MaxLength="2" onkeyup="if(isNaN(value))execCommand('undo');"></asp:TextBox>
                    密码长度必须大于等于8小于33
                </td>
            </tr>
        </table>
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td class="titleOpBg Lpd10">
                    <asp:Button ID="btnReset2" runat="server" Text="重置" CssClass="btn_operate" OnClick="btnReset_Click" />
                    <asp:Button ID="btnCreate2" runat="server" Text="生成" CssClass="btn_operate" OnClick="btnCreate_Click" />
                </td>
            </tr>
        </table>
    </form>
