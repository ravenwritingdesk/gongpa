    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td class="titleOpBg Lpd10">
                <input id="btnReturn2" type="button" value="返回" class="btn_operate" onclick="Redirect('GlobalLivcardList.aspx')" />
                <asp:Button ID="btnSave2" runat="server" Text="保存" CssClass="btn_operate" OnClick="btnSave_Click" />
            </td>
        </tr>
    </table>
    </form>
