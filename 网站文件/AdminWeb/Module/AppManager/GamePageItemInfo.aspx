...
<body>
    <form id="form1" runat="server">
        ...
        <ul class="tab_menu clearfix">
            ...
            <li class="cur" onclick="Redirect('GameNodeItemList.aspx')">节点</li>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
            <tr>
                <td height="35" colspan="2" class="f14 bold Lpd10 Rpd10">
                    <div class="hg3  pd7">
                        <asp:Literal ID="litInfo" runat="server"></asp:Literal>页面信息
                    </div>
                </td>
            </tr>
            <tr>
                <td class="listTdLeft">页面标识：
                </td>
                <td>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td class="titleOpBg Lpd10">
                    <input type="button" value="返回" class="btn_operate" onclick="Redirect('GameNodeItemList.aspx')" />
