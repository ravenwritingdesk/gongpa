        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
            <tr>
                <td height="35" colspan="2" class="f14 bold Lpd10 Rpd10">
                    <div class="hg3  pd7">
                        <asp:Literal ID="litInfo" runat="server"></asp:Literal>权限信息列表<asp:Literal ID="litSuper" runat="server"></asp:Literal>
                    </div>
                </td>
            </tr>
            <tr>
                            ...
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
                                <tr>
                                    <td height="35" class="f14 bold Lpd10 Rpd10">
                                        <div class="hg3  pd7">
                                            <asp:Label ID="lblParentName" runat="server"></asp:Label>（全选：<asp:CheckBox runat="server" ID="chkAll" name="chkAll" />）
                                        </div>
                                    </td>
                                </tr>
                                <tr>
