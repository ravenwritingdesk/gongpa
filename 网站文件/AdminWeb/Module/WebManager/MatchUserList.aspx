...
<body>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg">
        <tr>
            ...
            <td>
                ...
                <asp:Button ID="btnSearch" runat="server" Text="查询" CssClass="btn_operate" OnClick="btnSearch_OnClick" Visible="false" />
            </td>
        </tr>
    </table>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="39" class="titleOpBg">
                <asp:Button ID="btnDisable1" runat="server" Text="冻结" CssClass="btn_operate" OnClick="btnDisable_Click" OnClientClick="return deleteop()" />
                <asp:Button ID="btnEnable1" runat="server" Text="解冻" CssClass="btn_operate" OnClick="btnEnable_Click" OnClientClick="return deleteop()" />
            </td>
        </tr>
    </table>
    </form>
