            ...
            <div id="content" class="dataList">
                ...
                <table cellspacing="0" rules="all" style="border-collapse: collapse;" id="tableList">
                    <tr align="center" class="bold">
                        ...
                        <td class="listTitle2">桌子
                        </td>
                        <td class="listTitle2">用户数
                        </td>
                        <td class="listTitle2">机器人数
                        </td>
                        <td class="listTitle">损耗
                        </td>
                        <td class="listTitle">税收/服务费
                        </td>
                        <td class="listTitle">奖牌
                        </td>
                                ...
                                <td colspan="100">
                                    <table width="100%" border="0" align="center">
                                        <tr class="list" align="center">
                                            ...
                                            <td style="font-weight: bold;">是否机器人
                                            </td>
                                            <td style="font-weight: bold;">椅子编号
                                            </td>
                                            <td style="font-weight: bold;">输赢积分
                                            </td>
                                            <td style="font-weight: bold;">税收/服务费
                                            </td>
                                            <td style="font-weight: bold;">奖牌数目
                                            </td>
                                            <td style="font-weight: bold;">游戏时长
                                            </td>
