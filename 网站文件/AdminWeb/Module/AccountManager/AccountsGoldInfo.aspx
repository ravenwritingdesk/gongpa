...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <tr>
            ...
            <td width="1232" height="25" valign="top" align="left">目前操作功能：用户信息
            </td>
        </tr>
    </table>
    <!-- 头部菜单 End -->
    ...
    <ul class="tab_menu clearfix">
        ...
        <li class="cur"><a href="#" onclick="Redirect('AccountsGoldInfo.aspx?param='+GetRequest('param',0))">财富信息</a></li>
                ...
                <td>
                    <table border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
                        ...
                        <asp:Panel ID="plMsg" runat="server" Visible="false">
                            <tr>
                                <td style="height: 35px;" colspan="4">无任何记录！
                                </td>
                            </tr>
                        </asp:Panel>
                    </table>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td class="titleOpBg Lpd10">
                    ...
                    <%--<input type="button" value="关闭" class="btn_operate" onclick="window.close();" />--%><asp:Button ID="Button1" runat="server" Text="清除卡线" CssClass="btn_operate" OnClick="Button_ClearUserOnline" />
                </td>
