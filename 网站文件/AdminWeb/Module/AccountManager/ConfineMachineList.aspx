    ...
    <form id="form1" runat="server">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
            <tr>
                ...
                <td width="1232" height="25" valign="top" align="left">你当前位置：用户系统 - 限制机器码
                </td>
            </tr>
        </table>
        <!-- 头部菜单 End -->
        <div class="winQuery">
            ...
            <div id="content" class="dataList">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="OpList">
                    ...
                    <tr>
                        <td>
                            <input type="button" value="新增" class="btn_operate" onclick="Redirect('ConfineMachineInfo.aspx')" />
                        ...
                        <ItemTemplate>
                            <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                                ...
                                <td style="width: 100px;">
                                    <a class="l" href="<%#"ConfineMachineInfo.aspx?param="+Eval("MachineSerial").ToString()+"&reurl="+ Game.Utils.Utility.CurrentUrl %>">更新</a>
