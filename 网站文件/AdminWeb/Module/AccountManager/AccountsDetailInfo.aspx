...
<head runat="server">
    <title></title>
    <%--<link href="../../styles/layout.css" rel="stylesheet" type="text/css" /></script>--%>
...
<body>
    ...
    <ul class="tab_menu clearfix">
        ...
        <li class="cur"><a href="#" onclick="Redirect('AccountsDetailInfo.aspx?param='+GetRequest('param',0))">详细信息</a></li>
