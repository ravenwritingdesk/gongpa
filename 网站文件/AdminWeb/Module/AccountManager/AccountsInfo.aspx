...
<body>
    ...
    <ul class="tab_menu clearfix">
        <li class="cur"><a href="#" onclick="Redirect('AccountsInfo.aspx?param='+GetRequest('param',0))">基本信息</a></li>
        ...
        <li><a href="#" onclick="Redirect('AccountsRecordInfo.aspx?param='+GetRequest('param',0))">记录信息</a></li>
    </ul>
    ...
    <form runat="server" id="form1">
        ...
        <div class="container">
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
                ...
                <tr>
                    <td class="listTdLeft">ID号码(GameID)：
                    </td>
                    <td>
               ...
               <%-- <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <%--<asp:Literal ID="txtUnderWrite" runat="server"></asp:Literal>--%>
                    </td>
                </tr>
                <tr>
                    <td class="listTdLeft">性别：
                    </td>
                    <td>
                ...
                <tr>
                    <td class="listTdLeft">会员级别：
                    </td>
                    <td>
                        <asp:Literal ID="ltMemberInfo" runat="server"></asp:Literal>
                        <span id="plMemberList" runat="server" visible="false">&nbsp;<a href="javascript:void(0)" onclick="javascript:openWindowOwn('AccountsMemberList.aspx?param=<%= IntParam %>','_AccountsMemberList',800,500);" class="l">点击查看详情</a>
                        </span>
                    </td>
                </tr>
                <tr>
...
<%--                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <span style="margin-left: 2px;">
                            <input type="checkbox" onclick="SelectAllTable(this.checked, 'ckbUserRight')" id="ckbUserAll" />
                            全选</span>
                ...
                <tr>
                    <td class="listTdLeft">管理权限：
                    </td>
                    <td>
                        <span style="margin-left: 2px;">
                            <input type="checkbox" onclick="SelectAllTable(this.checked, 'ckbMasterRight')" id="ckbMasterAll" />
                            全选</span>
