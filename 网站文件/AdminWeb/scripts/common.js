document.write('<script src="../../scripts/jquery-1.8.3.min.js"></script>');
document.write('<script  type="text/javascript" src="../../scripts/dialog-min.js"></script>');
document.write('<script  type="text/javascript" src="../../scripts/dialog-plus-min.js"></script>');
/* 全局调试开关  0 关 1 开; */
var GLOBALS_DEBUG = 1;
...
/********************************************************************/
function showtable() {
    var mainTable = document.getElementById("tableList");
...
function SetTableRowColor() {
    $("#tableList tbody tr:odd").css("background-color", "#F3F8FE");

    $("#tableList tbody tr:even").css("background-color", "#F7F7F7");
