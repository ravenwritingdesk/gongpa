<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WinRanking.aspx.cs" Inherits="UserHandlerWeb.ReferencePage.WinRanking" %>
...
<body>
    ...
    <section class="Recharge">
        <ul class="tab_menu clearfix">
            <li onclick="redirectPageClick()">富豪榜</li>
            <li class="cur">赌神榜</li>
        </ul>
        <div class="tab_box">

            <div class="" date-name="赌神榜">
                <div class="DivBg">
                    <div class="DivBr">
                        <div class="">
                                    ...
                                    <asp:Repeater ID="reptDataPager" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td><%# Eval("RowId") %></td>
                                                <td><%# Eval("NickName") %></td>
                                                <td><%#UserHandlerWeb.App_Class.WebAppCommon.FormatMoney(Eval("WinScore").ToString()) %></td>
...
<script type="text/javascript">
    ...
    function redirectPageClick() {
        location.href = "/ReferencePage/ScoreRanking.aspx?Token=" + $("#<%=TokenHidden.ClientID %>").val() + "&UserId=" + $("#<%=UserIdHidden.ClientID %>").val();
    }
</script>
