<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Notice.aspx.cs" Inherits="Game.FrontWeb.Messages.Notice" %>
        ...
        <section class="Notice">
            <ul id="notices">
                <asp:Repeater ID="reptNews" runat="server">
                    <ItemTemplate>
                        <li class="read">
                            <h2 class="br4"><%# (Container.DataItem as Game.Entity.NativeWeb.News).Subject %></h2>
                            <div class="Article none">
                                <p>
                                    <%# (Container.DataItem as Game.Entity.NativeWeb.News).Body %>
                                </p>
                                <div class="date"><%# (Container.DataItem as Game.Entity.NativeWeb.News).IssueDate.ToString("yyyy年MM月dd日") %></div>
                            </div>
                        </li>
                    </ItemTemplate>
                </asp:Repeater>
