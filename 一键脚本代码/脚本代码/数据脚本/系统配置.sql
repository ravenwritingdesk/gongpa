...
INSERT [SystemStatusInfo] ([StatusName],[StatusValue],[StatusString],[StatusTip],[StatusDescription]) VALUES ( N'BankPrerequisite',10000,N'银行存取条件，存取金币数必须大于此数才可操作！',N'存取条件',N'键值：表示存取金币数必须大于此数才可存取')
...
INSERT [SystemStatusInfo] ([StatusName],[StatusValue],[StatusString],[StatusTip],[StatusDescription]) VALUES ( N'GrantIPCount',3,N'新用户注册IP每天赠送限制！',N'注册IP限制',N'键值：表示同一个IP最多赠送的次数，超过此数将不赠送金币')
INSERT [SystemStatusInfo] ([StatusName],[StatusValue],[StatusString],[StatusTip],[StatusDescription]) VALUES ( N'GrantScoreCount',8888,N'新用户注册系统送金币的数目！',N'注册赠送',N'键值：表示赠送的金币数量')
...
INSERT [SystemStatusInfo] ([StatusName],[StatusValue],[StatusString],[StatusTip],[StatusDescription]) VALUES ( N'TransferPrerequisite',100000,N'银行转账条件，转账金币数必须大于此数才可转账！',N'转账条件',N'键值：表示转账金币数必须大于此数才可转账')
